			...
			<div class="sidebar-inner slimscroll">
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<a href="leads.html" class="active"><i class="feather-user"></i> <span>Leads</span></a>
						</li>
							...
							<ul class="list-inline-item ps-0">
								...
								<li class="list-inline-item">
									<button
										...
										id="add-task" data-bs-toggle="modal" data-bs-target="#add_lead">New
										Lead</button>
								</li>
							</ul>
						</div>
								...
								<div class="table-responsive">
                                 ...
                                 ?>
											<tr>
												...
												<td><?php echo $show['GST_No'];?></td>
												<td><?php echo $show['Email'];?></td>
												<td><?php echo $show['Contact_No'];?></td>
												<td><?php echo $show['Address1'];?></td>
												<td><?php echo $show['Opening_Balance'];?></td>
												...
												<td class="text-center">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="#">Generate Merge
																Document</a>
															...
															<a class="dropdown-item" href="#">Add Activity Set To
																Lead</a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="forms-sample" action="add_cust.php" method = "POST">
