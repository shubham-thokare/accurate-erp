			...
			<div class="sidebar-inner slimscroll">
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<a href="leads.php" class="active"><i class="feather-user"></i> <span>Customer</span></a>
						</li>
						...
						<div class="col">
							...
							<div class="dropdown">
								<a class="dropdown-toggle recently-viewed" href="#" role="button"
									data-bs-toggle="dropdown" aria-expanded="false"> All Leads</a>
								<div class="dropdown-menu">
							...
							<ul class="list-inline-item ps-0">
								...
								<li class="list-inline-item">
									<button
										...
										id="add-task" data-bs-toggle="modal" data-bs-target="#add_lead">Create
										Customer</button>
								</li>
							</ul>
						</div>
									...
									<table class="table table-striped table-nowrap custom-table mb-0 datatable">
										<thead>
											...
											<tr style="background: linear-gradient(90deg, rgba(67,203,255,1) 25%, rgba(151,8,204,1) 100%);">
												...
												<th style="color: #fff;"> <strong> Company Name</strong></th>
												<th style="color: #fff;"><strong>Gst No </strong></th>
												<th style="color: #fff;"><strong>Email</strong></th>
												<th style="color: #fff;"><strong>Mobile</strong></th>
												<th style="color: #fff;"><strong>Address</strong></th>
												<th style="color: #fff;"><strong>City</strong></th>
												<th style="color: #fff;"><strong>Balance</strong></th>
...
?>
					...
					<div class="row">
                        ...
                        <form action="customerdb.php" method="POST">
								...
								<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="GST_No" maxlength="16" placeholder="Enter Gst No" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" required >

										<!-- <input name="ctl00$ContentPlaceHolder1$txtgstno" type="text" maxlength="15" id="ContentPlaceHolder1_txtgstno" class="form-control" placeholder="GST No." pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$"> -->

									</div>
								<div class="col-sm-6">
										<label class="col-form-label">Accounting Group</label>
										<input type="text" class="form-control" name="sundry"
											placeholder="Sundry Debtors" disabled="" style="background-color: gainsboro; ">
									</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="Address2" maxlength="10" placeholder="Address">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="Pincode" maxlength="6" placeholder="pincode">
									</div>
								</div>
	...
	<option value="36">Puducherry (Pondicherry)</option>
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="Country"
											placeholder="India" disabled="" style="background-color: gainsboro; ">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label"></label>
									...
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="tel" class="form-control" name="Contact_No" maxlength="10" placeholder="Mobile" >
									...
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="Vendor_Code" placeholder="Vender(code)" >
									</div>
								</div>
								<!-- <div class="form-group row">
									<div class="col-sm-6">
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="ShippingCustomer_Name" placeholder="Enter customer Name" required >
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">GST No</label>
										<input type="text" class="form-control" name="ShippingGST_No" maxlength="16" placeholder="Enter Gst No" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" required>
									</div>
								 </div>
                                <div class="col-sm-6">
										<label class="col-form-label">Address</label>
										<input type="text" class="form-control" name="ShippingAddress1" placeholder="Address">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">Address(Line 2)</label>
										<input type="text" class="form-control" name="ShippingAddress2" placeholder="Address">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
									...
									<div class="col-sm-6">
										<label class="col-form-label">Pincode</label>
										<input type="text" class="form-control" name="ShippingPincode" maxlength="6" placeholder="pincode">
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-sm-6">
                                    <label class="col-form-label"></label>
                                    <select  class="form-control" name="ShippingState" required>
	<option selected="selected" value="">--Select State--</option>
	<option value="1">Andhra Pradesh</option>
	<option value="2">Arunachal Pradesh</option>
	<option value="3">Assam</option>
	...
	<option value="36">Puducherry (Pondicherry)</option>
									...
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="ShippingCountry" required
											placeholder="India" disabled="" style="background-color: gainsboro; ">
									</div>
                                    <div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="ShippingContact_Person" placeholder="Contact Person" >
									</div>
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="tel" class="form-control" name="ShippingContact_No" maxlength="10" placeholder="Mobile" >
									</div>
</div>	
									<h4>Payment Terms</h4>
								<div class="form-group row">
									<div class="col-sm-12">
										...
										<textarea class="form-control" rows="3" id="description"
											placeholder="Terms" name="Terms" ></textarea>
									</div>
								</div>
								<div class="form-group row">
                                    <div class="col-sm-4">
