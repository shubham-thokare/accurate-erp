...
if (isset($_POST["getNewOrderItem"])) {
	...
	<!-- <tr>
		    ...
		    <td>
			<!-- <select class="select3 form-control select2-hidden-accessible" style="border-color:#fff !important;" name="prodname" id="select3" onchange="selectProduct()" data-select2-id="select3" tabindex="-1" aria-hidden="true"> -->
    
		        <select name="Product_Id[]" class="form-control form-control-sm Product_Id" style="height:50px;
    border: 1px solid #E5E5E5;
    border-radius: 6px;padding-right:30px;
    padding-left: 15px;" required>
		            <option value="">Select Product</option>
		            <?php 
		            	foreach ($rows as $row) {
		            		?><option value="<?php echo $row['Product_Id']; ?>"><?php echo $row["ProductName"]; ?></option><?php
		            	}
		            ?>
		        </select>
		    </td>
		    <td><input name="prod[]" type="text" class="form-control form-control-sm prod" required></td>
			<td><input name="hsn[]" type="text" class="form-control form-control-sm hsn" required></td>
		    ...
		    <td><input name="price[]" type="text" class="form-control form-control-sm price"></td>  
			<td><input name="discount[]" type="text" class="form-control form-control-sm discount" required></td>  

		    <input name="pro_name[]" type="hidden" class="form-control form-control-sm pro_name"></td>
		
		    <td><p class="amt" style="height:50px;
    border: 1px solid #E5E5E5;
    border-radius: 6px;"></p></td>
	<td><input name="discpunt[]" type="text" class="form-control form-control-sm discpunt" ></td> 
