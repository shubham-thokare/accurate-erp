													...
													<tbody id="display">
														<tr class="add-row" id="prod">
															<td>
																...
																<div class="selectBox">
																<select class="select3 form-control" style="    border-color:#fff !important;" name="product" id="product"  onchange="selectProduct()">
										...
										<div class="row">
											...
											<div class="col-lg-5 col-md-6">
												<div class="invoice-total-card">
                                                    ...
                                                    <!-- dummy taxable amount -->


                                                    <div class="invoice-total-box mt-3" id="displaygst">
														<div class="invoice-total-inner">
															<p>Taxable Amount <span>$21</span></p>
															<p>Round Off 
																<input type="checkbox" id="status_1" class="check">
