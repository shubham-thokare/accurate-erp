							...
							<ul class="list-inline-item ps-0">
								...
								<li class="list-inline-item">
									<button
										...
										id="add-task" data-bs-toggle="modal" data-bs-target="#add_customer">create
...
?>
    ...
    <!-- modal  -->
                   <div class="modal-body" id="add_customer">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
                        <form action="leaddb.php" method="POST">
								...
								<div class="form-group row">
									<div class="col-sm-6">
										<label class="col-form-label">Sundry Debitors</label>
										<select class="form-control" name="sundry">
                                        <option value="sundry">Sundry Debitors</option>
										</select>
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">Gst No</label>
										<input type="text" class="form-control" name="gst" placeholder="Enter Gst No">
									</div>
								</div>
								<!-- <div class="form-group row">
									<div class="col-sm-6">
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="address2" placeholder="Phone">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
									...
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="pin" placeholder="pincode">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="india"
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="ship_custname" placeholder="Enter customer Name">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">GST No</label>
										<input type="text" class="form-control" name="ship_gst" placeholder="Enter Gst No">
									</div>
								</div>
                                <div class="col-sm-6">
										<label class="col-form-label">Address</label>
										<input type="text" class="form-control" name="ship_address" placeholder="address">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">Address(Line 2)</label>
										<input type="text" class="form-control" name="ship_address2" placeholder="address">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6">
									...
									<div class="col-sm-6">
										<label class="col-form-label">Pincode</label>
										<input type="text" class="form-control" name="ship_pin" placeholder="pincode">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="ship_india"
											placeholder="India" disabled="" style="background-color: gainsboro; ">
									</div>
                                    <div class="col-sm-6">
										<label class="col-form-label"></label>
									...
									<div class="col-sm-6">
										...
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="email" placeholder="mail ID">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="vender" placeholder="Vender(code)">
									</div>
                                    <div class="col-sm-6">
										<label class="col-form-label"></label>
										<input type="text" class="form-control" name="opening" placeholder="Opening Balnce">
									</div>
                                    <div class="col-sm-4">
										<label class="col-form-label"></label>
