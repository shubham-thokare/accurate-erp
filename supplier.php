			...
			<div class="sidebar-inner slimscroll">
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<a href="leads.php" class="active"><i class="feather-user"></i> <span>Leads</span></a>
						</li>
									...
									<table class="table table-striped table-nowrap custom-table mb-0 datatable">
										<thead>
                                            <th>
												...
												<th style="color: #fff;"> <strong> Supplier Name</strong></th>
												<th style="color: #fff;"> <strong> Gst No </strong></th>
												<th style="color: #fff;"> <strong> Sundry Creditors </strong></th>
...
?>
				...
				<div class="modal-body">
					<div class="row">
                        ...
                        <form action="supplierdb.php" method="POST">
								...
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label"> Supplier Name <span
								...
								<div class="form-group row">
									...
									<label class="col-form-label">Gst No</label>
										<input type="text" class="form-control" name="GST_No" placeholder="Enter Gst No"  pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" required>
									</div>
									<div class="col-sm-6">
									<label class="col-form-label">Sundry Creditors</label>
									<input type="text" class="form-control" name="sundry"
											placeholder="Sundry Creditors" disabled="" style="background-color: gainsboro; ">
									</div>
								</div>
                            ...
                            <div class="form-group row">
								...
								<div class="form-group row">
									<!-- <div class="col-sm-6">
										...
										<input type="text" class="form-control" name="ship_custname" placeholder="supplier Name">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">GST No</label>
										<input type="text" class="form-control" name="ship_gst" placeholder="Enter Gst No"  pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" required>
									</div> -->
								</div>
                                <div class="col-sm-6">
	...
	<option value="36">Puducherry (Pondicherry)</option>
                                ...
                                <div class="col-sm-6">
										...
										<input type="text" class="form-control" name="Account_holder" placeholder="A/C Holder Name">
									</div>
                                    ...
                                    <div class="col-sm-6">
										<label class="col-form-label">Bank Name, Branch</label>
                                    ...
                                    <div class="col-sm-6">
										...
										<input type="text" class="form-control" name="opening_Balance" placeholder="Opening Balnce">
									</div>
                                    <div class="col-sm-4">
										<label class="col-form-label">Cr/Dr</label>
