...
<head>
	...
	<title>Products/Services - CRMS admin template</title>
			...
			<div class="sidebar-inner slimscroll">
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li>
							<a href="leads.php" class="active"><i class="feather-user"></i> <span>Products/Services</span></a>
						</li>
						...
						<li class="submenu">
							<a href="#"><i class="feather-clipboard"></i> <span> Invoices </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
                        ...
                        <li>
							<a href="supplier.php" class=""><i class="feather-user"></i> <span>Supplier</span></a>
						</li>
						...
						<li class="submenu">
							<a href="#"><i class="feather-alert-triangle"></i> <span> Error Pages </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather-list"></i> <span> Pages </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather feather-box"></i> <span>Elements </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather feather-bar-chart-2"></i> <span> Charts </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather feather-award"></i> <span> Icons </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather-credit-card"></i> <span> Forms </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="#"><i class="feather-box"></i> <span> Tables </span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
						...
						<li class="submenu">
							<a href="javascript:void(0);"><i class="feather-command"></i> <span>Multi Level</span> <span
									class="menu-arrow"></span></a>
							<ul class="sub-menus">
								<li class="submenu">
				...
				<div class="page-header pt-3 mb-0 ">
					<div class="row">
						<div class="col">
							...
							<div class="dropdown">
								<a class="dropdown-toggle recently-viewed" href="#" role="button"
									data-bs-toggle="dropdown" aria-expanded="false"> All Products/Services</a>
								<div class="dropdown-menu">
									<a class="dropdown-item" href="#">Recently Viewed</a>
									<a class="dropdown-item" href="#">Items I'm following</a>
									<a class="dropdown-item" href="#">All Products/Services</a>
									<a class="dropdown-item" href="#">All Closed Products/Services</a>
									<a class="dropdown-item" href="#">All Open Products/Services</a>
									<a class="dropdown-item" href="#">Converted Products/Services</a>
									<a class="dropdown-item" href="#">My Open Products/Services</a>
									<a class="dropdown-item" href="#">Todays Products/Services</a>
								</div>
							</div>
						</div>
						<div class="col text-end">
							<ul class="list-inline-item ps-0">
								...
								<li class="dropdown list-inline-item add-lists">
									<a class="dropdown-toggle recently-viewed pe-2" href="#" role="button"
								...
								<li class="dropdown list-inline-item add-lists">
									...
									<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="#" data-bs-toggle="modal"
											data-bs-target="#add-new-list">Add New List View</a>
									</div>
								</li>
								...
								<li class="list-inline-item">
									<button
										...
										id="add-task" data-bs-toggle="modal" data-bs-target="#add_product">create product/service</button>
								</li>
							</ul>
						</div>
					</div>
									...
									<table class="table table-striped table-nowrap custom-table mb-0 datatable">
										<thead>
                                            <th>
												...
												<th style="color: #fff;"> <strong> Sr No</strong</th>
												<th style="color: #fff;"> <strong> Product Name</strong</th>
												<th style="color: #fff;"> <strong>Product Description</strong</th>
												<th style="color: #fff;"> <strong> Product Type</strong</th>

												<th style="color: #fff;"> <strong> Part Code </strong</th>
												<th style="color: #fff;"> <strong> HSN Code</strong</th>
												<th style="color: #fff;"> <strong> Unit</strong</th>
												<th style="color: #fff;"> <strong> Rate</strong</th>
												<th style="color: #fff;"> <strong> Category</strong</th>
												<th style="color: #fff;"> <strong> Applicable Tax</strong</th>
												<th style="color: #fff;"> <strong> Opening Stock</strong</th>
...
$connection = mysqli_connect("localhost","root","","accurateerp");
...
<?php       
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="optionsRadios"
												id="optionsRadios1" value=""> Just For Me <i
												class="input-helper"></i></label>
									</div><br />
									<div class="form-check">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="optionsRadios"
												id="optionsRadios2" value="option2" checked=""> Share Filter with
											Everyone <i class="input-helper"></i></label>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="modal right fade" id="add_product" tabindex="-1" role="dialog" aria-modal="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title text-center">Create Customer</h4>
						  ...
						  <div class="col-md-12">
                                ...
                                <div class="row abc">
                                            <div class="col-md-3" style=text-align: center;>
                                                    <img src="assets/img/non-inventory.png" class="">
                                            </div>
                                        <div class="col-md-9">
                                           <button
										      class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded"
										       id="" data-bs-toggle="modal" data-bs-target="#add_prod">Add Product
											</button>
                                        </div>
                                </div>
                                <div class="row abc">
                                            <div class="col-md-3" style=text-align: center;>
                                                    <img src="assets/img/service.png" class="">
                                            </div>
                                        <div class="col-md-9">
                                            <button
										      class="add btn btn-gradient-primary font-weight-bold text-white  todo-list-add-btn btn-rounded"
										      id="" data-bs-toggle="modal" data-bs-target="#add_service">Add Service
											</button>
                                        </div>
								</div>
						</div>
    ...
    <!-- product modal  -->
    <!-- Modal -->
	<div class="modal right fade" id="add_prod" tabindex="-1" role="dialog" aria-modal="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
                        ...
                        <form action="productdb.php" method="POST">
								...
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label"> Product Name<span
												class="text-danger">*</span></label></div>
									<!-- <div class="col-md-4">
										<input class="form-control" type="text" placeholder="" name="prefix">
									</div> -->
									<div class="col-md-12">
								...
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label"> Product description<span
												class="text-danger">*</span></label></div>
									<!-- <div class="col-md-4">
										<input class="form-control" type="text" placeholder="" name="prefix">
									</div> -->
								...
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label"> Product Type<span
												class="text-danger">*</span></label></div>
									<!-- <div class="col-md-4">
										<input class="form-control" type="text" placeholder="" name="prefix">
									</div> -->
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="Part_Code" placeholder="Part Code">
									</div>
									<div class="col-sm-6">
                                ...
                                <div class="form-group row">
									<div class="col-sm-12">
										...
										<select class="form-control" name="Applicable_Tax">
											<option>Select Unit</option>
											...
											<option>GST@5%</option>
											<option>GST@3%</option>
											<option>GST@0%(Nill rated)</option>
                                ...
                                <div class="col-sm-12">
										...
										<input type="number" class="form-control" name="Opening_Stock" placeholder="Quantity">
									</div>
								...
								<div class="text-center py-3">
									<button type="submit"
										class="border-0 btn btn-primary btn-gradient-primary btn-rounded" name="submit">Save</button>&nbsp;&nbsp;
    ...
    <!-- modal -->
    <div class="modal right fade" id="add_service" tabindex="-1" role="dialog" aria-modal="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">

				<div class="modal-header">
					<h4 class="modal-title text-center">Create Service</h4>
					<button type="button" class="btn-close xs-close" data-bs-dismiss="modal"></button>
				</div>
				...
				<div class="modal-body">
					<div class="row">
                        ...
                        <form action="productdb.php" method="POST">
								...
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label">Service description
								...
								<div class="form-group row">
									<div class="col-sm-6">
										...
										<input type="text" class="form-control" name="service_code" placeholder="Service Code">
									</div>
									<div class="col-sm-6">
										<label class="col-form-label">SAC Code</label>
                                ...
                                <div class="form-group row">
									<div class="col-sm-12">
										...
										<select class="form-control" name="catagory">
											<option>Select Unit</option>
											<option>Legal & Accounting Service</option>
											<option>Financial Service</option>
											<option>Transpost Service</option>
											<option>Distribution Service</option>
											<option>Postal & Courier Service</option>
											<option>Real Estate Service</option>
											<option>Leasing or Rental Service</option>
											<option>Research & Development Service</option>
											<option>Legal & Accounting Service</option>
											<option>Labour Work Service</option>
											<option>Professional, Technical & Bussiness Service</option>
											<option>Telecommunications, Broadcasting & Information Supply Service</option>
											<option>Placement & Recruitment Service</option>
											<option>Labour Supply Service</option>
											<option>Maintenance, Repair & Installation Service</option>
											<option>Manufacturing Service</option>
											<option>Publishing, Printing & Reproduction Service</option>
											<option>Public Administration & Other Service</option>
											<option>Education Service</option>
											<option>Human Sealth & Social Care Service</option>
					...
					<div class="tab-content pipeline-tabs border-0">
							...
							<div class="">
								<div class="task-infos">
									<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
										<li class="nav-item"><a class="nav-link active" href="#not-contact-task-details"
												data-bs-toggle="tab">Details</a></li>
										<li class="nav-item"><a class="nav-link" href="#not-contact-task-related"
												data-bs-toggle="tab">Related</a></li>
										<li class="nav-item"><a class="nav-link" href="#not-contact-task-activity"
									...
									<div class="tab-content">
										<div class="tab-pane show active p-0" id="not-contact-task-details">
											<div class="crms-tasks">
												<div class="tasks__item crms-task-item active">
													<div class="accordion-header js-accordion-header">Lead Information
													</div>
												...
												<div class="tasks__item crms-task-item">
													<div class="accordion-header js-accordion-header">Additional
														Information</div>
													<div class="accordion-body js-accordion-body">
														<div class="accordion-body__contents">
															<table class="table">
												...
												<div class="tasks__item crms-task-item">
													<div class="accordion-header js-accordion-header">Address
														Information</div>
													<div class="accordion-body js-accordion-body">
														<div class="accordion-body__contents">
															<table class="table">
																<tbody>
																	<tr>
																		<td> Address</td>
																		<td>1000 Escalon Street, Palo Alto, CA, 94020,
																			United States map</td>
																	</tr>
																</tbody>
															</table>
														</div>
												...
												<div class="tasks__item crms-task-item">
													<div class="accordion-header js-accordion-header">Description
														Information</div>
													<div class="accordion-body js-accordion-body">
														<div class="accordion-body__contents">
															<table class="table">
												...
												<div class="tasks__item crms-task-item">
													<div class="accordion-header js-accordion-header">Tag Information
													</div>
													<div class="accordion-body js-accordion-body">
														<div class="accordion-body__contents">
															<table class="table">
												...
												<div class="tasks__item crms-task-item">
													<div class="accordion-header js-accordion-header">Lead Conversion
														Information</div>
													<div class="accordion-body js-accordion-body">
														<div class="accordion-body__contents">
															<table class="table">
										...
										<div class="tab-pane task-related p-0" id="not-contact-task-related">
											<div class="row">
												...
												<div class="col-md-4">
													<div
														class="card bg-gradient-danger card-img-holder text-white h-100">
														<div class="card-body">
															<img src="assets/img/circle.png" class="card-img-absolute"
																alt="circle-image">
										...
										<div class="tab-pane p-0" id="not-contact-task-activity">
											<div class="row">
												...
												<div class="col-md-4">
													<div
														class="card bg-gradient-success card-img-holder text-white h-100">
														<div class="card-body">
															<img src="assets/img/circle.png" class="card-img-absolute"
																alt="circle-image">
											...
											<div class="row">
												<div class="crms-tasks  p-2">
													<div class="tasks__item crms-task-item active">
														<div class="accordion-header js-accordion-header">Upcoming
															Activity </div>
														<div class="accordion-body js-accordion-body">
															<div class="accordion-body__contents">
																<div class="table-responsive">
													...
													<div class="tasks__item crms-task-item">
														<div class="accordion-header js-accordion-header">Past Activity
														</div>
														<div class="accordion-body js-accordion-body">
															<div class="accordion-body__contents">
																<div class="table-responsive">
						...
						<div role="tabpanel" class="tab-pane p-0" id="attempted-contact">
							<div>
								<div class="task-infos">
									<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
										<li class="nav-item"><a class="nav-link active" href="#attempted-task-details"
												data-bs-toggle="tab">Details</a></li>
										<li class="nav-item"><a class="nav-link" href="#attempted-task-related"
												data-bs-toggle="tab">Related</a></li>
										<li class="nav-item"><a class="nav-link" href="#attempted-task-activity"
												data-bs-toggle="tab">Activity</a></li>
						...
						<div role="tabpanel" class="tab-pane p-0" id="contact">
							<div>
								<div class="task-infos">
									<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
										<li class="nav-item"><a class="nav-link active" href="#contact-task-details"
												data-bs-toggle="tab">Details</a></li>
										<li class="nav-item"><a class="nav-link" href="#contact-task-related"
												data-bs-toggle="tab">Related</a></li>
										<li class="nav-item"><a class="nav-link" href="#contact-task-activity"
												data-bs-toggle="tab">Activity</a></li>
						...
						<div role="tabpanel" class="tab-pane p-0" id="converted">
							<div>
								<div class="task-infos">
									<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
										<li class="nav-item"><a class="nav-link active" href="#converted-task-details"
												data-bs-toggle="tab">Details</a></li>
										<li class="nav-item"><a class="nav-link" href="#converted-task-related"
												data-bs-toggle="tab">Related</a></li>
										<li class="nav-item"><a class="nav-link" href="#converted-task-activity"
												data-bs-toggle="tab">Activity</a></li>
										...
										<div class="themes">
											<div class="themes-body">
												<ul id="theme-changes"
													...
													<li class="list-inline-item"><span onclick="toggleTheme('style')"
										...
										<div class="themes">
											<div class="themes-body">
												<ul id="theme-change1"
													...
													<li class="list-inline-item"><span
															class="header-gradient-color2 bg-tempting-azure"></span>
													</li>
													<li class="list-inline-item"><span
										...
										<div class="themes">
											<div class="themes-body">
												<ul id="theme-change2"
													...
													<li class="list-inline-item"><span
															class="sidebar-gradient-color1 bg-sunny-morning"></span>
													</li>
													<li class="list-inline-item"><span
															class="sidebar-gradient-color2 bg-tempting-azure"></span>
													</li>
													<li class="list-inline-item"><span
