...
<head>
	...
	<title>Ledger - CRMS admin template</title>
						...
						<div class="col text-end">
							<ul class="list-inline-item ps-0">
								...
								<li class="list-inline-item">
									<button class="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-bs-toggle="modal" data-bs-target="#add_lead">create
										Ledger</button>
								</li>
							</ul>
						</div>
									...
									<table class="table table-striped table-nowrap custom-table mb-0 datatable">
										<thead>
											...
											<tr style="background: linear-gradient(90deg, rgba(67,203,255,1) 25%, rgba(151,8,204,1) 100%);">
												...
												<th style="color: #fff;"> <strong>Leger Name</strong></th>
												<th style="color: #fff;"> <strong>Group</strong></th>

												<th style="color: #fff;"> <strong>Balance</strong></th>
												<th style="color: #fff;"> <strong>Gst</strong></th>

												<th style="color: #fff;"> <strong>Dr_Cr</strong></th>
										...
										<tbody>
											...
											?>
													...
													<tr>
														...
														<td><?php echo $row['Accounting_Group']; ?></td>
						...
						<div class="form-group row pt-4">
							...
							<div class="col-sm-8">
								<div class="form-group">
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios2" value="option2" checked=""> Share Filter with
	...
	<div class="modal right fade" id="add_lead" tabindex="-1" role="dialog" aria-modal="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-header">
					<h4 class="modal-title text-center">Create Ledger</h4>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<form action="leaderdb.php" method="POST">
								<!-- <h4>Customer Information</h4> -->
								<div class="form-group row">
									<div class="col-md-12"><label class="col-form-label">Ledger Name <span class="text-danger">*</span></label></div>
									<!-- <div class="col-md-4">
								...
								<div class="form-group row">
									<div class="col-sm-6">
										<label class="col-form-label">List Of Groups</label>
										<select name="product" class="form-control" required>
											...
											<option value="Loans and Advances (Assets)">Loans and Advances (Assets)</option>
											<option value="Loans Liabilities">Loans Liabilities</option>
											<option value="Misc. Expense (ASSET)">Misc. Expense (ASSET)</option>
									...
									<div class="col-sm-6">
										...
										<select name="gst" class="form-control" style="background-color:LightGrey;" required>
									...
									<div class="form-group row">
										<div class="col-sm-6">
											...
											<input type="text" class="form-control" name="opening" placeholder="Opening Balnce" required>
										</div>
										<div class="col-sm-6">
											<label class="col-form-label"></label>
								...
								<div class="text-center py-3">
									<button type="submit" class="border-0 btn btn-primary btn-gradient-primary btn-rounded" name="submit">Save</button>&nbsp;&nbsp;
										...
										<div class="themes">
											<div class="themes-body">
												<ul id="theme-change1" class="theme-colors border-0 list-inline-item list-unstyled mb-0">
													...
													<li class="list-inline-item"><span class="header-gradient-color2 bg-tempting-azure"></span>
													</li>
										...
										<div class="themes">
											<div class="themes-body">
												<ul id="theme-change2" class="theme-colors border-0 list-inline-item list-unstyled">
													...
													<li class="list-inline-item"><span class="sidebar-gradient-color1 bg-sunny-morning"></span>
													</li>
													<li class="list-inline-item"><span class="sidebar-gradient-color2 bg-tempting-azure"></span>
													</li>
