...
?>
	<div class="selectBox">
		<select class="select3 form-control" style="border-color:#fff !important;" name="product" id="product1" onchange="selectProduct(1)">
...
<td>
<input type="text" class="form-control" id="pdesc1">
</td>

<td>
<input type="text" class="form-control" id="hsn1">
</td>
<td>
<input type="number" class="form-control" id="qty1" value="1" onchange="updateAmount(1)">
</td>
<td>
<input type="text" class="form-control" id="unit1">
</td>
<td>
<input type="text" class="form-control" id="price1" onchange="updateAmount(1)">
</td>
<td>
<input type="text" class="form-control" id="discount1" value="0" onchange="updateAmount(1)">
</td>
<td>
<input type="text" class="form-control" name="amount" id="amount1">
</td>
<td>
<input type="text" class="form-control" id="tax1" value="0" onchange="updateAmountOnTax(1)">
</td>
...
<a href="javascript:void(0);" onclick="updateSubTotal()">
<p>Gross Total 
<span id= "grossTotal"></span></p>
<!-- <p>Round Off
<input type="checkbox" id="status_1" class="check">
<label for="status_1" class="checktoggles">checkbox</label>
<span id="roundOff">$1</span>
</p> -->

<p>Transport charge
<span id="transportCharge">$1</span>
</p>
...
<h4>
<a href="javascript:void(0);" onclick="finalSum()">
	Total Amount <span id="finalTotal"></span></h4>
</div>
</div>
</div>
...
function calculateDiscount() {
	...
	transportCharges = (document.getElementById("transportCharge").textContent).replace("$","");
	otherCharges = (document.getElementById("otherCharge").textContent).replace("$","");

	discount = (document.getElementById("discountInPercent").textContent);
...
function finalSum() {
	...
	console.log("Gross total is :: " + (document.getElementById("grossTotal").textContent).replace("$",""));
	// console.log("Round off value is :: " + (document.getElementById("roundOff").textContent).replace("$",""));
	console.log("Transport charge is :: " + (document.getElementById("transportCharge").textContent).replace("$",""));
	console.log("Other charge value is :: " + (document.getElementById("otherCharge").textContent).replace("$",""));
	...
	sumVal =  sumVal + parseFloat(subTotal) + parseFloat(transportCharges) + parseFloat(otherCharges) - parseFloat(discount);
...
$(document).on("click",".add-btns",function () {
	...
	var experiencecontent = '<tr class="add-row" id="prod'+prod_id+'">' +
		'<td>' +
		'<div class="selectBox">'+
		'<select class="select3 form-control" name="product" id="product'+prod_id+'" onchange="selectProduct('+prod_id+')">'+
		'<option id="test"  value="">-- select Product --</option>'+
			<?php
	   ...
	   '</div>'+
		...
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="pdesc'+prod_id+'">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="hsn'+prod_id+'">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="qty'+prod_id+'" value="1" onchange="updateAmount('+prod_id+')">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="unit'+prod_id+'">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="price'+prod_id+'" onchange="updateAmount('+prod_id+')">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" id="discount'+prod_id+'" value="0" onchange="updateAmount('+prod_id+')">' +
		'</td>' +
		'<td>' +
		'<input type="text" class="form-control" name="amount" id="amount'+prod_id+'">' +
	'</td>' +
	'<td>' +
		'<input type="text" class="form-control" id="tax'+prod_id+'" value="0" onchange="updateAmountOnTax('+prod_id+')">' +
	'</td>' +
		'<td class="add-remove text-end">' +
		' <a href="javascript:void(0);" class="add-btns me-2"><i class="fas fa-plus-circle"></i></a> ' +
		' <a href="#" class="copy-btn me-2"><i class="fas fa-copy"></i></a>' +
