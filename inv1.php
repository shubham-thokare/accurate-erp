...
<td>
<input type="number" class="form-control" id="qty1" name="qty1" value="1" onchange="finalamount(),calculateSGST12onvalue(),updateAmount(1),updateSubTotal(),finalSum(),calculateSGST18onvalue(),calculateSGST12(),calculateSGST18(),calculateSGST28(),calculateSGST28onvalue(),totalAmountWithTax(),finalamount()">
</td>
<td>
<input type="text" class="form-control" id="unit1" name="unit1">
</td>
<td>
<input type="text" class="form-control" id="price1" name="price1" onchange="updateAmount(1),updateSubTotal(),calculateSGST12onvalue(),finalamount(),finalSum(),calculateSGST12(),calculateSGST18onvalue(),calculateSGST18(),calculateSGST28(),calculateSGST28onvalue(),totalAmountWithTax(),finalamount()">
</td>
<td>
<input type="text" class="form-control" id="discount1" name="discount1" value="0" onkeyup="updateAmount(1),calculateSGST12onvalue(),finalamount(),updateSubTotal(),finalSum(),calculateSGST18onvalue(),calculateSGST12(),calculateSGST18(),calculateSGST28(),calculateSGST28onvalue(),totalAmountWithTax(),finalamount()">
</td>
<td>
<input type="text" class="form-control" name="amount1" id="amount1">
</td>
<td>
<input type="text" class="form-control" id="tax1" name="tax1" value="" onchange="cgst(),sgst()">
</td>
...
<p>Transport charge
<span><input style="width:50px;margin-left:200px;" type="text" id="transportCharge" value="0"></span>
...
<p>Other charge
<span><input style="width:50px;margin-left:200px;" type="text" id="otherCharge" name="othercharges" value="0"></span>
...
<p>Other Discount 
<span><input style="width:50px;margin-left:200px;" type="text" id="otherDiscount" value="0"></span>
...
<p>Discount in %
<span><input style="width:50px;margin-left:200px;" type="text" id="discountInPercent" value="0"></span>
<!-- 
<span id="discountInPercent">10</span> -->

<!-- <span id="discountInPercent">10</span> -->
</p>
<!-- <a href="jafascript:void(0);" onclick="calculateDiscount()"> -->
<p>Discount in $
...
<div class="invoice-total-footer">
<h4>
<!-- <a onchange="finalSum(),updatemount(),calculateDiscount(),calculateSGST12onvalue(),start();finalamount(),calculateSGST12(),calculateSGST18(),calculateSGST18onvalue(),calculateSGST28(),totalAmountWithTax(),calculateSGST28onvalue(),getNumberOFRowsInTable()"> -->
