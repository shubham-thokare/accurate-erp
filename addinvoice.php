...
<html lang="en">
    <head>
        ...
        <!-- custom js file for customer selection -->
							...
							<div class="card invoices-add-card">
								<div class="card-body">
									<form action="#" class="invoices-form">
												...
												<div class="col-xl-4 col-md-6 col-sm-12 col-12">
													<div class="form-group">
														...
														<div class="multipleSelection">
                                                                ...
                                                                <select id="custname" class="selectBox" name="cname" id="cname">
                                                                    <option value="">-- Select Customer --</option>

																	<!-- fetch value inside dropdown list -->
                                                                <?php  
													...
													<div class="form-group">
														...
														<input class="form-control"  name="ponumber" type="text" placeholder="Enter Reference Number">
													</div>
												</div>
												<div class="col-xl-5 col-md-6 col-sm-12 col-12">
													...
													<div class="invoice-details-box">
														<div class="invoice-inner-head">
															<span>Invoice No. <a href="view-invoice.html">01</a></span>
														</div>
                                        ...
                                        <!-- check incoming ajax request coming from getData.js -->
										...
										<div class="invoice-item">
											<div class="row">
												...
												<div class="col-xl-4 col-lg-6 col-md-6">
													<div class="invoice-info hidden" id="invoice-info">
